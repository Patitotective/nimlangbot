...
proc main() = 
  ...
  let data = twitterApi.tweetsSearchRecent("(#nimlang OR #nim_lang OR nimlang OR nim_lang OR from:nim_lang) lang:en -malware -virus -is:retweet", {"max_results": "50"}.newStringTable).body.parseJson()["data"]
